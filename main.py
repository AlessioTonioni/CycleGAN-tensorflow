...
parser.add_argument('--num_sample',dest='num_sample',type=int,default=1000,help='number of sample to process for 1 epoch')
...
parser.add_argument('--job-dir',help="ignore")
